        ...
        <nav class="navbar nav_bottom">
            ...
            <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                <ul class="nav navbar-nav nav_1">
                    <li><a href="products.html">Фирменная продукция</a></li>
                    <li><a href="household.html">Домашнее</a></li>
                    <li class="dropdown mega-dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Овощи и фрукты<span class="caret"></span></a>
                        <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
                            <div class="w3ls_vegetables">
                                <ul>
                                    <li><a href="vegetables.html">Овощи</a></li>
                                    <li><a href="vegetables.html">Фрукты</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Напитки<span class="caret"></span></a>
                        <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
                            <div class="w3ls_vegetables">
                                <ul>
                                    <li><a href="drinks.html">Безалкогольные напитки</a></li>
                                    <li><a href="drinks.html">Соки</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
                    <li><a href="pet.html">Корм для животных</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Замороженная пища<span class="caret"></span></a>
                        <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
                            <div class="w3ls_vegetables">
                                <ul>
                                    <li><a href="frozen.html">Замороженные закуски</a></li>
                                    <li><a href="frozen.html">Замороженая не веганская еда</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
                    <li><a href="bread.html">Хлеб и Выпечка</a></li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    </div>
